      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {projects.map((project, index) => (
          <motion.a
            ...
            className="relative group bg-white/10 border border-white/20 text-white p-6 rounded-2xl shadow-lg backdrop-blur-md transition-all block overflow-hidden"
